...
const ROUTES = ['/', '/comicreader', '/webapp', '/grepreader', '/grepreader/changelog', '/grepreader/privacy', '/archive', '/archive/changelog', '/archive/privacy', '/smartdecrypt', '/smartdecrypt/changelog', '/smartdecrypt/privacy', '/contentcue', '/contentcue/changelog', '/contentcue/privacy', '/about', '/privacy', '/blog', '/changelog', ...ARTICLE_SLUGS.map(s => `/blog/${s}`)];
...
for (const lang of SUPPORTED_LANGUAGES) {
    for (const route of ROUTES) {
        ...
        if (lang !== 'en' && NOINDEX_NON_EN_ROUTES.has(route)) {
