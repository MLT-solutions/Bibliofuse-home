...
Multiplique por uma série longa. Uma biblioteca manga de 50 volumes em PNG ocupa cerca de **20 GB**. A mesma série comprimida para WebP cabe em **2,5 GB** — uma economia de **17,5 GB** de uma única série. Ferramentas como o [BiblioFuse](https://bibliofuse.com) fazem essa conversão completamente no dispositivo, sem precisar de nenhum software no computador.
