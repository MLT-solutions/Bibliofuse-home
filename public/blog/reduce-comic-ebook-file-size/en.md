...
Scale that across a long series. A 50-volume manga library in PNG format takes up roughly **20 GB**. The same series compressed to WebP fits in about **2.5 GB** — a saving of **17.5 GB** from a single series.
