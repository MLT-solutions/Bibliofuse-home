...
Sur une longue série, une bibliothèque manga de 50 tomes en PNG occupe environ **20 Go**. La même série compressée en WebP tient dans **2,5 Go** — soit **17,5 Go** économisés sur une seule série.
