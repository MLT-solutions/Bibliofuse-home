...
Archive Duplicate Scanner encuentra fotos duplicadas en Mac mediante hash perceptual, una técnica que identifica imágenes visualmente idénticas aunque tengan nombres de archivo distintos, formatos diferentes o ajustes de compresión variados. Es compatible con HEIC, WebP, JPEG, PNG, TIFF, RAW y docenas de otros formatos. La aplicación está disponible para Mac y Windows, y mueve los duplicados a la Papelera de forma segura en lugar de eliminarlos permanentemente.
