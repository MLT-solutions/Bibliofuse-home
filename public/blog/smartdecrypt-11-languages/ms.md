...
## Mengapa Penyata Bank Adalah Kes Penggunaan Utama

Kebanyakan orang tidak menganggap diri mereka sebagai pengguna alat penyahsulitan. Sehingga bank mula menghantar PDF berkata laluan setiap bulan.
...
| Bahasa | Baharu dalam kemas kini ini |
|--------|-----------------------------|
| Inggeris | — |
| Sepanyol | — |
| Portugis | — |
...
Setiap teks yang kelihatan dalam aplikasi telah diterjemahkan — menu, butang bar alat, giliran fail, lencana status, dialog pemadanan corak, gesaan naik taraf Pro, dan panel keutamaan.

SmartDecrypt mengikut bahasa peranti anda secara automatik. Di iOS: **Tetapan → Umum → Bahasa & Wilayah**. Di macOS: **Tetapan Sistem → Umum → Bahasa & Wilayah**. Di Windows: **Tetapan → Masa & Bahasa → Bahasa & Wilayah**.

## Format Fail yang Disokong

**PDF** — format yang digunakan bank, syarikat insurans, dan agensi kerajaan untuk penyata. SmartDecrypt membuka kunci PDF dan menyimpan salinan bersih.

**ZIP** — arkib ZIP yang disulitkan untuk pek dokumen dan muat turun. SmartDecrypt mengekstrak kandungannya tanpa meninggalkan aplikasi.

**7z** — format 7-Zip sumber terbuka, biasa untuk arkib besar. Sokongan penuh untuk fail yang disulitkan dan tidak disulitkan.

## Cara Kerja Pemadanan Corak

Apabila anda menerima fail, SmartDecrypt membandingkan nama failnya dengan profil yang disimpan. Cipta profil dengan nama, corak (mis. `CIMB_*.pdf`), dan kata laluan. Apabila fail yang sepadan tiba, SmartDecrypt menerapkan kata laluan yang disimpan secara automatik.

Kata laluan disimpan dalam Apple Keychain atau Windows Credential Manager. Tidak pernah dihantar ke mana-mana pelayan.
