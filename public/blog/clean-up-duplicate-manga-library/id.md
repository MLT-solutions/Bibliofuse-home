...
Panduan ini menjelaskan alur kerja praktis untuk menemukan, meninjau, dan menghapus manga duplikat menggunakan [Comic Duplicate Scanner](/en/archive/) — utilitas Mac yang dirancang khusus untuk masalah ini.
...
## Yang Dilakukan Comic Duplicate Scanner Secara Berbeda

[Comic Duplicate Scanner](/en/archive/) menggunakan **perceptual hashing** untuk membandingkan gambar sebenarnya di dalam arsip CBZ dan CBR Anda. Alih-alih bertanya "apakah dua file ini identik byte demi byte?", ia bertanya "apakah dua arsip ini berisi halaman komik yang sama?"
...
Buka Comic Duplicate Scanner dan tambahkan folder manga. Anda bisa drag and drop folder langsung ke aplikasi.
...
Setelah scan selesai, Comic Duplicate Scanner menampilkan pasangan yang cocok berdampingan dengan preview thumbnail, ukuran file, dan persentase kemiripan.
...
Comic Duplicate Scanner memindahkan file ke Trash — bukan penghapusan permanen. Anda bisa memulihkan file jika diperlukan.
...
**Pindai setelah setiap sesi unduhan besar.** Jalankan Comic Duplicate Scanner setelah mengunduh sekelompok volume baru.
...
**Apakah Comic Duplicate Scanner akan menghapus file saya secara otomatis?**
...
Ya. Comic Duplicate Scanner menggunakan perceptual hashing pada gambar di dalam setiap arsip, bukan checksum file.
