...
Dit is het probleem dat perceptuele hashing oplost, en het is de techniek in de kern van [Archive Duplicate Scanner](/en/archive/).
...
[Archive Duplicate Scanner](/en/archive/) past perceptuele hashing toe op archiefniveau:
...
[Archive Duplicate Scanner](/en/archive/) is een native Mac-app die perceptuele hashing naar je volledige bibliotheek brengt. Het verplaatst geselecteerde duplicaten naar de Prullenmand (geen definitieve verwijdering).
