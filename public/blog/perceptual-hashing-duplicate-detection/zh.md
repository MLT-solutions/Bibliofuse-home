...
这就是感知哈希解决的问题，也是 [Comic Duplicate Scanner](/zh/archive/) 核心技术。
...
[Comic Duplicate Scanner](/zh/archive/) 在档案级别应用感知哈希：
...
[Comic Duplicate Scanner](/zh/archive/) 是一款原生 Mac 应用，将感知哈希技术带到整个图书库。它将选定的重复文件移至废纸篓（非永久删除）。
