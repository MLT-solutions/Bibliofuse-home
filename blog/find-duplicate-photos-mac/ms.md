...
[Comic Duplicate Scanner](/ms/archive/) mencari foto pendua di Mac menggunakan perceptual hashing — teknik yang memadankan imej yang identik secara visual walaupun mempunyai nama fail, format atau tetapan mampatan yang berbeza. Ia menyokong HEIC, WebP, JPEG, PNG, TIFF, RAW dan berpuluh-puluh format lain. Aplikasi ini tersedia untuk Mac dan Windows, dan memindahkan pendua ke Tong Sampah dengan selamat, bukannya memadamnya secara kekal.
...
Perceptual hashing melihat bagaimana imej *kelihatan*, bukan apa yang dikatakan baitnya. Comic Duplicate Scanner mengira cap jari visual yang padat untuk setiap foto. Dua imej yang kelihatan sama pada mata manusia menghasilkan cap jari yang sama (atau sangat serupa) — walaupun satu dalam format HEIC dan yang lain JPEG, walaupun satu dieksport semula pada kualiti 85%, dan walaupun seseorang menamakan semula fail tersebut.
...
1. **Muat turun dan buka Comic Duplicate Scanner** dari Mac App Store atau laman web pembangun.
...
5. **Pilih strategi pemadaman** — Comic Duplicate Scanner menawarkan strategi pemilihan automatik: simpan fail terbesar (kualiti tertinggi), simpan yang tertua (asal), atau simpan yang berada dalam folder pilihan. Anda juga boleh memilih secara manual.
...
Comic Duplicate Scanner mengendalikan setiap format yang ditemui oleh jurugambar Mac:
...
Selepas setiap penghijrahan Mac, Migration Assistant Apple menyalin fail tetapi tidak mendeduplikasinya. Jika anda pernah berpindah antara Mac lebih daripada sekali, kemungkinan besar anda mempunyai dua atau tiga salinan foto terlama. Jalankan Comic Duplicate Scanner pada folder home anda untuk mencari semuanya.

**2. Pasangan RAW + JPEG**
Banyak kamera — dan mod ProRAW iPhone — menyimpan RAW dan JPEG secara serentak. Selepas mengedit dalam Lightroom atau Capture One, anda sering tidak lagi memerlukan JPEG asal. Comic Duplicate Scanner mengumpulkan fail RAW bersama padanan JPEG-nya supaya anda boleh membersihkan yang lebih tanpa mengisih secara manual mengikut tarikh.

**4. Foto berwarna lwn. eksport hitam putih**
Anda mengambil gambar dalam warna tetapi mengeksport versi hitam putih untuk projek, kemudian terlupa yang mana satunya. Kerana perceptual hashing membandingkan struktur luminans berbanding nilai warna, foto berwarna asal dan eksport skala kelabunya menghasilkan hash yang hampir sama dan dikumpulkan sebagai pendua — walaupun alat berasaskan bait melihatnya sebagai fail yang berbeza sepenuhnya.
...
### Adakah Comic Duplicate Scanner memadamkan foto secara kekal?
...
### Bolehkah ia memadankan foto berwarna dengan versi hitam putih imej yang sama?

Ya. Algoritma dHash menukar setiap imej kepada skala kelabu sebelum mengira cap jarinya, yang bermaksud ia membandingkan corak luminans berbanding nilai warna. Foto berwarna penuh dan eksport hitam putihnya menghasilkan hash yang hampir sama dan dikumpulkan sebagai pendua.

### Adakah resolusi imej mempengaruhi pengesanan pendua?

Tidak. dHash mengubah saiz setiap imej kepada grid tetap kecil sebelum membandingkan, jadi muat turun web resolusi rendah dan asal resolusi tinggi foto yang sama menghasilkan hash yang sama. Perbezaan resolusi antara sumber diabaikan sepenuhnya.

### Adakah Comic Duplicate Scanner tersedia untuk Windows?

Ya. Comic Duplicate Scanner tersedia untuk Mac dan Windows. Versi Windows mempunyai enjin perceptual hashing yang sama dan menyokong format fail yang sama.

## Pulihkan Storan Anda — Tanpa Risiko

Perpustakaan dengan 40,000 foto dan 30% pendua membazirkan berpuluh-puluh gigabait storan. Comic Duplicate Scanner memberikan anda alat untuk membersihkannya dengan selamat — perceptual hashing yang menangkap pendua visual merentas format, strategi pemilihan automatik yang menghapuskan tekaan, dan pemadaman ke Tong Sampah sahaja yang memastikan anda terlindung.

[Muat turun Comic Duplicate Scanner](/ms/archive/) dan mulakan imbasan pertama anda hari ini. Jika anda juga ingin memampatkan atau menukar secara berkelompok koleksi foto anda, [Alat Web BiblioFuse](/ms/webapp/) mengendalikan fail EPUB, CBZ dan PDF sepenuhnya dalam pelayar anda.
