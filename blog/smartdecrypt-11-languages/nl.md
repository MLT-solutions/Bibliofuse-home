...
## Waarom Bankafschriften de Kerngebruikssituatie Zijn

De meeste mensen denken niet dat ze een decryptietool nodig hebben. Totdat hun bank maandelijks met wachtwoord beveiligde PDFs begint te sturen.
...
Elke zichtbare tekst in de app is vertaald — menu's, werkbalkknopppen, de bestandswachtrij, statusbadges, patroonmatchingdialogen, Pro-upgrade-prompts en het voorkeursvenster.

SmartDecrypt volgt automatisch de taal van je apparaat. Op iOS: **Instellingen → Algemeen → Taal en regio**. Op macOS: **Systeeminstelling → Algemeen → Taal en regio**. Op Windows: **Instellingen → Tijd en taal → Taal en regio**.

## Ondersteunde Bestandsformaten

**PDF** — het formaat dat banken, verzekeraars en overheidsinstanties gebruiken voor afschriften. SmartDecrypt ontgrendelt de PDF en slaat een schone kopie op.

**ZIP** — versleutelde ZIP-archieven voor documentbundels en downloads. SmartDecrypt extraheert de inhoud zonder de app te verlaten.

**7z** — het open-source 7-Zip formaat, veelgebruikt voor grote archieven. Volledige ondersteuning voor versleutelde en niet-versleutelde bestanden.

## Hoe Patroonmatching Werkt

Wanneer je een bestand ontvangt, vergelijkt SmartDecrypt de bestandsnaam met je opgeslagen profielen. Maak een profiel aan met naam, patroon (bijv. `Rabobank_*.pdf`) en wachtwoord. Wanneer een overeenkomend bestand binnenkomt, past SmartDecrypt het opgeslagen wachtwoord automatisch toe.

Wachtwoorden worden opgeslagen in de Apple Sleutelhanger of Windows Credential Manager. Ze gaan nooit naar een server.
