...
## Por Qué los Extractos Bancarios Son el Caso de Uso Principal

La mayoría de las personas no se consideran usuarios de herramientas de descifrado. Hasta que el banco empieza a enviar PDFs protegidos con contraseña cada mes.
...
Cada cadena visible en la aplicación está traducida — menús, botones de barra de herramientas, la cola de archivos, insignias de estado, diálogos de coincidencia de patrones, solicitudes de actualización Pro y el panel de preferencias.

SmartDecrypt sigue el idioma de tu dispositivo automáticamente. En iOS: **Ajustes → General → Idioma y región**. En macOS: **Configuración del Sistema → General → Idioma y Región**. En Windows: **Configuración → Hora e idioma → Idioma y región**.

## Formatos de Archivo Compatibles

SmartDecrypt gestiona los tres formatos que regularmente llegan con contraseñas:

**PDF** — el formato que bancos, aseguradoras y organismos gubernamentales usan para extractos. SmartDecrypt desbloquea el PDF y guarda una copia limpia.

**ZIP** — archivos ZIP cifrados para paquetes de documentos y descargas. SmartDecrypt extrae el contenido sin salir de la app.

**7z** — el formato 7-Zip de código abierto, habitual en archivos grandes. Soporte completo para archivos cifrados y sin cifrar.

## Cómo Funciona la Coincidencia de Patrones

Cuando recibes un archivo, SmartDecrypt compara su nombre con tus perfiles guardados. Creas un perfil con nombre, patrón (por ejemplo `BBVA_*.pdf`) y contraseña. Cuando llega un archivo que coincide, SmartDecrypt aplica la contraseña guardada y lo desbloquea automáticamente.

Las contraseñas se almacenan en Apple Keychain o en el administrador de credenciales de Windows. Nunca van a ningún servidor.
