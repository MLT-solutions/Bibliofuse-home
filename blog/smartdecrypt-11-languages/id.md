...
## Mengapa Laporan Bank Adalah Kasus Penggunaan Utama

Kebanyakan orang tidak menganggap diri mereka pengguna alat dekripsi. Sampai bank mulai mengirimkan PDF berpassword setiap bulan.
...
Setiap teks yang terlihat dalam aplikasi telah diterjemahkan — menu, tombol toolbar, antrean file, badge status, dialog pencocokan pola, prompt peningkatan Pro, dan panel preferensi.

SmartDecrypt mengikuti bahasa perangkat Anda secara otomatis. Di iOS: **Pengaturan → Umum → Bahasa & Wilayah**. Di macOS: **Pengaturan Sistem → Umum → Bahasa & Wilayah**. Di Windows: **Pengaturan → Waktu & Bahasa → Bahasa & Wilayah**.

## Format File yang Didukung

**PDF** — format yang digunakan bank, perusahaan asuransi, dan lembaga pemerintah untuk laporan. SmartDecrypt membuka kunci PDF dan menyimpan salinan bersih.

**ZIP** — arsip ZIP terenkripsi untuk paket dokumen dan unduhan. SmartDecrypt mengekstrak isinya tanpa meninggalkan aplikasi.

**7z** — format 7-Zip sumber terbuka, umum untuk arsip besar. Dukungan penuh untuk file terenkripsi maupun tidak.

## Cara Kerja Pencocokan Pola

Saat Anda menerima file, SmartDecrypt membandingkan nama filenya dengan profil yang tersimpan. Buat profil dengan nama, pola (mis. `Mandiri_*.pdf`), dan kata sandi. Saat file yang cocok tiba, SmartDecrypt menerapkan kata sandi yang tersimpan secara otomatis.

Kata sandi disimpan di Apple Keychain atau Windows Credential Manager. Tidak pernah dikirim ke server mana pun.
