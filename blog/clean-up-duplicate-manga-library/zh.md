...
本指南介绍了一个实用的工作流程，用 [Archive Duplicate Scanner](/zh/archive/) 来查找、审查并删除重复漫画——这是一款专为此问题设计的 Mac 工具。
...
[Archive Duplicate Scanner](/zh/archive/) 使用**感知哈希**来比较CBZ和CBR文件内部的实际图像。它不是问"这两个文件是否逐字节相同？"，而是问"这两个文件是否包含相同的漫画页面？"
