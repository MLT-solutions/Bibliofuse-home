...
Esse é o problema que o hash perceptual resolve, e é a técnica no núcleo do [Archive Duplicate Scanner](/en/archive/).
...
O [Archive Duplicate Scanner](/en/archive/) aplica hash perceptual no nível do arquivo:
...
O [Archive Duplicate Scanner](/en/archive/) é um aplicativo Mac nativo que traz hash perceptual para toda sua biblioteca. Move duplicatas selecionadas para a Lixeira (não exclusão permanente).
