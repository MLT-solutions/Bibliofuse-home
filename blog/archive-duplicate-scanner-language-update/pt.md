...
- **Correspondência difusa de nomes de arquivo** — detecta "Spider-Man #001" vs "spiderman_001" sem abrir nenhum arquivo. Compatível com Unicode.
- **Seleção automática inteligente** — escolha qual cópia manter por regra: Maior arquivo, Mais recente, Mais antigo ou Mais páginas.
- **Exclusão segura apenas** — move arquivos para a Lixeira do macOS ou Recycle Bin do Windows. Nada é excluído permanentemente.
- **Cache de hash (SQLite)** — resultados são armazenados localmente. Re-escanear uma pasta após adicionar novos arquivos só processa os novos.
- **Exportação rica** — relatórios CSV e HTML com miniaturas e pontuações de similaridade.
- **100% local** — sem nuvem, sem análise, sem conta necessária.
