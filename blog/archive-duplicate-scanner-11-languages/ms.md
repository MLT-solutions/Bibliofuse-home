...
Pencari pendua standard membandingkan nama, saiz, atau cincang. Pendekatan itu gagal dengan arkib komik kerana:

- **Kandungan sama, nama berbeza**: `Spider-Man_001.cbz` dan `spiderman_issue01.cbz` adalah komik yang sama, tetapi tiada perbandingan nama yang mengesannya
...
Keseluruhan antara muka aplikasi diterjemahkan — kawalan imbasan, senarai keputusan, label keyakinan padanan, butang tindakan, dan panel keutamaan.
