# Como Abrir PDFs de Extratos Bancários com Senha no iPhone
...
**Passo 1 — Crie um perfil por instituição**

Abra o SmartDecrypt e toque em + para adicionar um novo perfil. Dê um nome, um padrão de nome de arquivo (ex.: `Bradesco_*.pdf`) e a senha dessa instituição.

**Passo 2 — Jogue o arquivo dentro**

Quando o extrato mensal chegar, toque em Compartilhar e selecione SmartDecrypt. O app verifica o nome do arquivo com seus perfis salvos, aplica a senha armazenada e desbloqueia o PDF.

**Passo 3 — Vários bancos, vários perfis**

- `Itau_*.pdf` → seu CPF
- `SulAmerica_*.pdf` → seu número de apólice
- `Receita_*.pdf` → seu CPF

## Armazenamento Seguro

Senhas são armazenadas no Apple Keychain. Nunca são enviadas a nenhum servidor.
