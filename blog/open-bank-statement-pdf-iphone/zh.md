...
打开 SmartDecrypt，点击 + 添加新配置。输入名称、文件名模式（如 `招商银行_*.pdf`）以及该机构的密码。

**第二步 — 拖入文件**

每月账单到达时，点击分享并选择 SmartDecrypt。应用将文件名与已保存的配置对比，匹配后自动应用密码并解锁 PDF。
